...
export declare class OrderResolver {
    ...
    transitionFulfillmentToState(ctx: RequestContext, args: MutationTransitionFulfillmentToStateArgs): Promise<import("../../..").FulfillmentStateTransitionError | Fulfillment>;
